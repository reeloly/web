...
function ProjectPage() {
	...
	// Use sandbox hook at parent level to share state between Video and Chat
	const sandboxStatus = useSandbox(projectId);
	...
	// Video component
	const videoContent = (
		<Video projectId={projectId} sandboxStatus={sandboxStatus} />
	);
